// Example 16.4: StringStartEnd.java
...
public class StringStartEnd
{
	public static void main( String[] args )
	{
		...
		}	// end for loop to test which strings start wtih 'st'
		...
		}	// end for loop to test position-based startsWith

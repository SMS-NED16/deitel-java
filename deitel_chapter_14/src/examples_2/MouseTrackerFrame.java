// Example 14.9a - MouseTrackerFrame.java
...
public class MouseTrackerFrame extends JFrame
{
	...
	public MouseTrackerFrame() 
	{
		...
		mousePanel = new JPanel();		// create a panel
		mousePanel.setBackground( Color.BLACK );	// set bg color to white
	...
	// private inner class to implement MouseListener
		...
		MouseListener, MouseMotionListener
	{
		...
		{
			statusBar.setText( "Mouse out JPanel" );

// Example 10.1 - PolymorphismTest.java
// Assigning superclass and subclass references to superclass
...
public class PolymorphismTest
{
	public static void main( String[] args )
	{
		...
		// invoke toString on superclass object using a superclass variable
		...
		System.out.printf( "%s %s:\n\n%s\n", 
				...
				"referene to subclass object", commissionEmployee2.toString() );
	}	// end method main

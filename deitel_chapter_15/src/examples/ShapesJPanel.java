// Example 15.9a - ShapesJPanel.java
...
public class ShapesJPanel extends JPanel
{
	...
	public void paintComponent( Graphics g )
	{
		...
		gg.fillRect( 0, 0, 10, 10 );		// draw in a filled rectangle
		gg.setColor( Color.BLACK );			// draw in black
		gg.drawRect( 1, 1, 6, 6 );			// draw in a rectangle
		gg.setColor( Color.BLUE );			// draw in blue
		gg.fillRect( 1, 1, 3, 3 );			// draw a filled rectangle
		gg.setColor( Color.RED );			// draw in red
		gg.fillRect( 4, 4, 3, 3 );			// draw in a filled rectangle
		
		// paint buffImage onto JFrame
